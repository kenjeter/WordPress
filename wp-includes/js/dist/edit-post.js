...
/* harmony default export */ var reducer = (Object(external_wp_data_["combineReducers"])({
            ...
            function* setAvailableMetaBoxesPerLocation(metaBoxesPerLocation) {
                ...
                //
                // See: https://github.com/in-the-south-media-init/blob/5.1.1/wp-admin/includes/post.php#L2307-L2309
            ...
            ***************************************************************************** */
            ...
            function createDomMotionConfig(Component, _a, preloadedFeatures, createVisualElement) {
                ...
                return __assign(__assign({}, baseConfig), {
                    preloadedFeatures: preloadedFeatures, useRender: createUseRender(forwardMotionProps), createVisualElement: createVisualElement,
                    Component: Component
                });
            }
...
/* harmony default export */ var es = (sync);
            ...
            function inertia_inertia(_a) {
                ...
                function startAnimation(options) {
                    ...
                    currentAnimation = animations_animate(tslib_tslib_es6_assign(tslib_tslib_es6_assign({}, options), {
                        driver: driver, onUpdate: function (v) {
                            var _a;
            ...
            var default_transitions_keyframes = function (values) {
                return ({
                    type: "keyframes",
                    duration: 0.8,
                    values: values,
            ...
            var filter = tslib_es6_assign(tslib_es6_assign({}, complex), {
            ...
            function transitions_getAnimation(key, value, target, transition, onComplete) {
                ...
                function start() {
                    ...
                    return valueTransition.type === "inertia" ||
                        ...
                        : animations_animate(__assign(__assign({}, getPopmotionAnimationOptions(valueTransition, options, key)), {
                            onUpdate: function (v) {
                                var _a;
                                options.onUpdate(v);
            ...
            var svgVisualElement = render_visualElement(__assign(__assign({}, htmlConfig), {
                getBaseTarget: function (props, key) {
                    return props[key];
                },
                readValueFromInstance: function (domElement, key) {
...
/* harmony default export */ var components_layout = (Layout);
            ...
            function Editor({
                ...
                const editorSettings = Object(external_wp_element_["useMemo"])(() => {
                    const result = {
                        ...Object(external_lodash_["omit"])(settings, ['styles']),
